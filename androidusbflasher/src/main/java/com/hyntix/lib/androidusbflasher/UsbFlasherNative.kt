...
internal interface UniffiCallbackInterfaceFlashCallbackMethod0 : com.sun.jna.Callback {
    fun callback(`uniffiHandle`: Long,`phase`: RustBuffer.ByValue,`current`: Long,`total`: Long,`uniffiOutReturn`: Pointer,uniffiCallStatus: UniffiRustCallStatus,)
}
@Structure.FieldOrder("uniffiFree", "uniffiClone", "onProgress")
internal open class UniffiVTableCallbackInterfaceFlashCallback(
    @JvmField internal var `uniffiFree`: UniffiCallbackInterfaceFree? = null,
    @JvmField internal var `uniffiClone`: UniffiCallbackInterfaceClone? = null,
    @JvmField internal var `onProgress`: UniffiCallbackInterfaceFlashCallbackMethod0? = null,
) : Structure() {
    class UniffiByValue(
        `uniffiFree`: UniffiCallbackInterfaceFree? = null,
        `uniffiClone`: UniffiCallbackInterfaceClone? = null,
        `onProgress`: UniffiCallbackInterfaceFlashCallbackMethod0? = null,
    ): UniffiVTableCallbackInterfaceFlashCallback(`uniffiFree`,`uniffiClone`,`onProgress`,), Structure.ByValue

   internal fun uniffiSetValue(other: UniffiVTableCallbackInterfaceFlashCallback) {
...
public interface UsbFlasherInterface {
...
open class UsbFlasher: Disposable, AutoCloseable, UsbFlasherInterface
{
    ...
    @Throws(FlasherException::class)override fun `flashDevice`(`imageFd`: kotlin.Int, `usbFd`: kotlin.Int, `interface`: kotlin.UByte, `inEp`: kotlin.UByte, `outEp`: kotlin.UByte, `verify`: kotlin.Boolean, `callback`: FlashCallback)
        = 
    callWithHandle {
    ...
    @Throws(FlasherException::class)override fun `isLinuxIso`(`fd`: kotlin.Int): kotlin.Boolean {
 ...
 * @suppress
 */
public object FfiConverterTypeUsbFlasher: FfiConverter<UsbFlasher, Long> {
    override fun lower(value: UsbFlasher): Long {
        return value.uniffiCloneHandle()
    }

    override fun lift(value: Long): UsbFlasher {
        return UsbFlasher(UniffiWithHandle, value)
    }

    override fun read(buf: ByteBuffer): UsbFlasher {
        return lift(buf.getLong())
    }

    override fun allocationSize(value: UsbFlasher) = 8UL

    override fun write(value: UsbFlasher, buf: ByteBuffer) {
        buf.putLong(lower(value))
    }
}
 ...
 * @suppress
 */
public object FfiConverterTypeFlashPhase: FfiConverterRustBuffer<FlashPhase> {
    override fun read(buf: ByteBuffer) = try {
        FlashPhase.values()[buf.getInt() - 1]
    } catch (e: IndexOutOfBoundsException) {
        throw RuntimeException("invalid enum value, something is very wrong!!", e)
    }

    override fun allocationSize(value: FlashPhase) = 4UL

    override fun write(value: FlashPhase, buf: ByteBuffer) {
...
sealed class FlasherException: kotlin.Exception() {
    ...
    companion object ErrorHandler : UniffiRustCallStatusErrorHandler<FlasherException> {
        override fun lift(error_buf: RustBuffer.ByValue): FlasherException = FfiConverterTypeFlasherError.lift(error_buf)
    }
 ...
 * @suppress
 */
public object FfiConverterTypeFlasherError : FfiConverterRustBuffer<FlasherException> {
    override fun read(buf: ByteBuffer): FlasherException {
        

        return when(buf.getInt()) {
            1 -> FlasherException.IoException(
                FfiConverterString.read(buf),
                )
            2 -> FlasherException.UsbException(
                FfiConverterString.read(buf),
                )
            3 -> FlasherException.Cancelled()
            4 -> FlasherException.InvalidIso(
                FfiConverterString.read(buf),
                )
            5 -> FlasherException.Unknown(
                FfiConverterString.read(buf),
                )
    ...
    override fun allocationSize(value: FlasherException): ULong {
        return when(value) {
            is FlasherException.IoException -> (
                // Add the size for the Int that specifies the variant plus the size needed for all fields
                4UL
                + FfiConverterString.allocationSize(value.`msg`)
            )
            is FlasherException.UsbException -> (
                // Add the size for the Int that specifies the variant plus the size needed for all fields
                4UL
                + FfiConverterString.allocationSize(value.`msg`)
            )
            is FlasherException.Cancelled -> (
                // Add the size for the Int that specifies the variant plus the size needed for all fields
                4UL
            )
            is FlasherException.InvalidIso -> (
                // Add the size for the Int that specifies the variant plus the size needed for all fields
                4UL
                + FfiConverterString.allocationSize(value.`msg`)
            )
            is FlasherException.Unknown -> (
                // Add the size for the Int that specifies the variant plus the size needed for all fields
                4UL
                + FfiConverterString.allocationSize(value.`msg`)
            )
    ...
    override fun write(value: FlasherException, buf: ByteBuffer) {
        when(value) {
            is FlasherException.IoException -> {
                buf.putInt(1)
...
public interface FlashCallback {
    ...
    fun `onProgress`(`phase`: FlashPhase, `current`: kotlin.ULong, `total`: kotlin.ULong)
...
internal object uniffiCallbackInterfaceFlashCallback {
    internal object `onProgress`: UniffiCallbackInterfaceFlashCallbackMethod0 {
        override fun callback(`uniffiHandle`: Long,`phase`: RustBuffer.ByValue,`current`: Long,`total`: Long,`uniffiOutReturn`: Pointer,uniffiCallStatus: UniffiRustCallStatus,) {
            val uniffiObj = FfiConverterTypeFlashCallback.handleMap.get(uniffiHandle)
            val makeCall = { ->
                uniffiObj.`onProgress`(
                    FfiConverterTypeFlashPhase.lift(`phase`),
    ...
    internal object uniffiFree: UniffiCallbackInterfaceFree {
        override fun callback(handle: Long) {
            FfiConverterTypeFlashCallback.handleMap.remove(handle)
        }
    }

    internal object uniffiClone: UniffiCallbackInterfaceClone {
        override fun callback(handle: Long): Long {
            return FfiConverterTypeFlashCallback.handleMap.clone(handle)
        }
    }

    internal var vtable = UniffiVTableCallbackInterfaceFlashCallback.UniffiByValue(
        uniffiFree,
        uniffiClone,
        `onProgress`,
    )
 ...
 * @suppress
 */
public object FfiConverterTypeFlashCallback: FfiConverterCallbackInterface<FlashCallback>()
